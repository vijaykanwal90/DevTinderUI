    ...
    <div>
       <Card key={user._id} className="py-4 bg-gray-500 m-4">
        <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
          <p className="text-tiny uppercase font-bold">{firstName + " " + lastName}</p>
        ...
        <button className='bg-red-600' onClick={ requestSent('ignored',_id)}>Ignore</button>

        <button className='bg-green-600' onClick={ requestSent('interested',_id)}>Interested</button>
